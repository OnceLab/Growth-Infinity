...
function setup() {
    ...
    let n = 16;
    for (let i = 0; i < n; i++ ) {
        // A nice pattern generated by this line
        // use really slow and dark lines to let the shape gradually become light.
        // 16 lines make sure that there is enough focused pattern on the screen.
        complex.push(new RanLife(0 + 120 * i,i * 2.714 / 10,1));
    }
}
